...
object ItemUtil {
	...
	fun enchantThing(item: ItemStack, enchant: Enchantment, level: Int): ItemStack {
	...
	fun randomPotionData(type: PotionType): PotionData {
		val extended = type.isExtendable && Random.nextBoolean()
		val upgraded = !extended && type.isUpgradeable && Random.nextBoolean()
	...
	fun randomStew(): ItemStack {
		...
		meta.addCustomEffect(randomPotionEffect(Random.nextBoolean(), 10 * 20, 1), true)
