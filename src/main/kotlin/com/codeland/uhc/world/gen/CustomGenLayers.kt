...
object CustomGenLayers {
	...
	private fun <T : Area, C : AreaContextTransformed<T>> createAreaFactoryGame(
		...
		baseLayer = GenLayerZoom.NORMAL.a(seed.apply(1001L), baseLayer)

		baseLayer = GenLayerMerge().a(seed.apply(49L), baseLayer)
		baseLayer = GenLayerIdBiome().a(seed.apply(3333L), baseLayer)

		baseLayer = GenLayerZoom.NORMAL.a(seed.apply(1002L), baseLayer)
		...
		riverLayer = GenLayerZoom.NORMAL.a(seed.apply(1002L), riverLayer)
		riverLayer = GenLayerZoom.NORMAL.a(seed.apply(1003L), riverLayer)
		riverLayer = GenLayerZoom.NORMAL.a(seed.apply(1004L), riverLayer)
		riverLayer = GenLayerEdge(BiomeNo.RIVER).a(seed.apply(122L), riverLayer)
		riverLayer = GenLayerZoom.NORMAL.a(seed.apply(1005L), riverLayer)
