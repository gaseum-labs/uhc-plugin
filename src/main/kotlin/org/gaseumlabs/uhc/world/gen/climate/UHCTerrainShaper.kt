...
object UHCTerrainShaper {
	...
	fun createGame(amplified: Boolean): TerrainShaper {
		...
		val cubicSpline6 = CubicSpline.builder(UHC_CONTINENTS, NO_TRANSFORM).addPoint(-0.19f, 3.95f, 0.0f)
			...
			.addPoint(0.06f, getErosionFactor(4.69f, false, amplifiedFactor), 0.0f).build()
		val cubicSpline7 = CubicSpline.builder(UHC_CONTINENTS, amplifiedJaggedness).addPoint(-0.11f, 0.0f, 0.0f)
